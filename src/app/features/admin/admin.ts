...
@Component({
  ...
  styles: [`
    ...
    .admin-input { flex: 1; min-width: 140px; padding: 10px 14px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 6px; color: #fff; font-size: 0.85rem; }
    ...
    .table-header, .table-row { display: grid; grid-template-columns: 1.5fr 1.5fr 0.8fr 0.8fr 1fr 0.5fr 0.5fr; gap: 10px; padding: 10px 12px; align-items: center; font-size: 0.8rem; }
